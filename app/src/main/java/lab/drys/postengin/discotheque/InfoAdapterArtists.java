 ...
 */
public class InfoAdapterArtists extends CursorAdapter
{
	public InfoAdapterArtists(Context context, Cursor cursor)
	{
	...
	public void bindView(View view, Context context, Cursor cursor)
	{
		...
		File image = new File(context.getApplicationInfo().dataDir+"/artists/"+cursor.getString(1)+".jpg");
