 ...
 */
public class QueuePopulatorAlbum extends AsyncTask<String,Void,Cursor>
{
	public QueuePopulatorAlbum(Context cntx)
	{
		context = cntx;
		postExecute = false;
	}

	public QueuePopulatorAlbum(Context cntx, boolean bln)
	{
		context = cntx;
		postExecute = bln;
	}
